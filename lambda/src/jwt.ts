...
// Minimal HS256 JWT implementation using Node's built-in crypto. The intent-parser
// Lambda verifies tokens issued by the auth Lambda. No third-party dependency.
...
export function verifyJwt(token: string, secret: string): VerifyResult {
  ...
  // timingSafeEqual requires equal lengths; bail out early to avoid throw.
