...
export const officeSpace: World = {
  ...
  rooms: {
    ...
    initech_lobby_post: {
      ...
      description:
        'The HANG IN THERE kitten is still hanging in there. You walk past it without acknowledging its struggle. A small conference room has been set up off the lobby — apparently The Bobs are conducting "interviews."',
      exits: {
